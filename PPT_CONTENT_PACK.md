...
**Course:** Work System Design (WSD), Department of Industrial & Systems Engineering / Mechanical Engineering, Indian Institute of Technology Kharagpur (IIT Kharagpur)  
...
- **Candidate Details:** [Candidate Name] | Roll No: [Roll Number] | Course: Work System Design | IIT Kharagpur
- **Visual Asset:** Department branding & IIT Kharagpur crest (Canva template); Pair with technical cutaway backdrop or `ppt_assets/14_boiler_photorealistic_schematic.png` (ambient watermarked).
...
> *"Good morning, respected committee members. Today, I am defending my project: a **Physics-Informed Digital Twin for Predictive Maintenance of Industrial Boilers**.*  
> 
...
- **On-Slide Content:**
  ...
  - **Work System Instantiation:**
    ...
    - **Environment & Strategy:** Ambient thermodynamic weather swings, grid power demand shifts, ASME Section I Boiler Code, OSHA 1910.147 LOTO compliance, and IIT Kharagpur WSD curriculum principles.
...
*Anticipated challenge questions from IIT Kharagpur faculty and comprehensive, mathematically grounded defense rebuttals.*
...
6. Once generated, open the deck **in Canva Pro directly** (not just via chat) to hand-polish: swap in your IIT Kharagpur branding, fix any font/spacing issues, and do a final pass checking that no AI-rendered image slipped in from the "DO NOT USE" list above.
